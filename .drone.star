...
def main(ctx):
  ...
  osx_cxx("B2_TOOLSET=clang B2_CXXSTD=03,11,17 Job 13", "g++", packages="binutils-gold gdb libc6-dbg", buildtype="boost", environment={'B2_TOOLSET': 'clang', 'B2_CXXSTD': '03,11,17', 'DRONE_JOB_OS_NAME': 'osx', 'DRONE_JOB_UUID': 'bd307a3ec3'}, globalenv=globalenv),
